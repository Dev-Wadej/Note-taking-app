        ...
        return<>
            ...
            <Form>
              <Row className="mb-4">
                ...
                isMulti value={selectedTags.map(tags=>(
                    {label:tags.label,value:tags.id}
                ))}
                onChange={tags=>{
            ...
            <EditTagsModal onUpdate={onUpdateTag} onDelete={onDeleteTag} show={editTagModalIsOpen} handleClose={()=>setEditTagModalIsOpen(false)} availableTags={availableTags}/>
        </>
}
...
function EditTagsModal({availableTags,handleClose,show,onDelete,onUpdate}:EditTagModalProps){
            ...
            <Form>
                <Stack gap={2}>
                    {availableTags.map(tag=>(
                        <Row key={tag.id}>
                            <Col>
                                <Form.Control onChange={e=> onUpdate(tag.id,e.target.value)} type="text" value={tag.label}/>
